...
ActiveRecord::Schema.define(version: 20160315094032) do
  ...
  create_table "tsum_segments", force: :cascade do |t|
    t.string "code",    null: false
    t.string "segment", null: false
  end

  add_index "tsum_segments", ["code", "segment"], name: "index_tsum_segments_on_code_and_segment", unique: true, using: :btree
  add_index "tsum_segments", ["code"], name: "index_tsum_segments_on_code", using: :btree

  create_table "tsum_tracks", force: :cascade do |t|
    t.string   "engine"
    t.string   "block"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.string   "ssid"
    t.string   "item_uniqid"
  end

  add_index "tsum_tracks", ["engine", "block"], name: "index_tsum_tracks_on_engine_and_block", using: :btree
  add_index "tsum_tracks", ["engine", "created_at"], name: "index_tsum_tracks_on_engine_and_created_at", using: :btree
  add_index "tsum_tracks", ["engine"], name: "index_tsum_tracks_on_engine", using: :btree
