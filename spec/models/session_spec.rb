...
describe Session do
  describe '.fetch' do
    context 'with existing session' do
      ...
      subject { Session.fetch(uniqid: @session.uniqid, useragent: sample_useragent ) }
    ...
    context 'without existing session' do
      subject { Session.fetch(uniqid: nil, useragent: sample_useragent ) }
  ...
  describe '.create_with_uniqid_and_user' do
    subject { Session.create_with_uniqid_and_user(useragent: sample_useragent) }
    ...
    it 'assigns useragent to returned session' do
      expect(subject.useragent).to eq sample_useragent
    end
  end
end
