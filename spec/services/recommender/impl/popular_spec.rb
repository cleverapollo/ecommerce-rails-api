...
describe Recommender::Impl::Popular do
  ...
  let!(:params) { OpenStruct.new(shop: shop, user: user, limit: 7, type: 'popular', profile: People::Profile.new(gender: 'm')) }
      ...
      context 'fashion_sizes' do
        ...
        context 'fit sizes' do
          before {
            ...
            params.profile = People::Profile.new(fashion_sizes: {shoe: ['1', '2']}, gender: 'f')
          }
