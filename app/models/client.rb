...
class Client < ActiveRecord::Base
  ...
  scope :ready_for_trigger_mailings, -> { with_email.where("triggers_enabled = 't' AND ((last_trigger_mail_sent_at is null) OR  last_trigger_mail_sent_at < NOW() - INTERVAL '#{shop.trigger_pause} days')") }
