...
class ItemCategory < ActiveRecord::Base
  ...
  TAXONOMY_KEYWORDS = {
      ...
      'country_yard.furniture.bench' => ['скамейк'],
      'country_yard.furniture.hammok' => ['гамак'],

      'furniture.living_room.sofa' => ['диван', 'тахта'],
      'furniture.living_room.cabinet' => ['шкаф'],
      'furniture.living_room.chair' => ['кресл'],
      'furniture.living_room.shelving' => ['стеллаж', 'полки'],
      'furniture.bedroom.bed' => ['кроват'],
      'furniture.bedroom.mattress' => ['матрац'],
      'furniture.bedroom.pillow' => ['подукш'],
      'furniture.bedroom.blanket' => ['одеял'],
      ...
      'furniture.universal.light' => ['люстр', 'светильник', 'торшер'],
